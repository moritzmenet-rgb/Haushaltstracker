...
import { Cloud, ArrowRight, ShieldCheck, Sparkles, LogIn, HardDrive } from 'lucide-react';
...
export const CloudOnboarding: React.FC<CloudOnboardingProps> = ({ onLocalSetup }) => {
  const { loginWithGoogle, firebaseError } = useApp();
    ...
    <div className="fixed inset-0 z-[100] bg-[var(--m3-surface)] flex items-center justify-center p-6 overflow-y-auto">
      ...
      >
        <motion.div 
          ...
          className="w-20 h-20 bg-[var(--m3-primary)] rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-lg"
        >
